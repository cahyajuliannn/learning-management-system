...
public class SecurityConfig {
  ...
  public SecurityFilterChain filterChain(
    ...
    return http.addFilterBefore(
        ...
        .permitAll()
        .antMatchers(HttpMethod.GET, "/subjects/student/*/all")
        ...
        .antMatchers(
            ...
            "/subject-enrollments/student/*/total-ects")
        .hasAnyAuthority(ROLE_STUDENT, ROLE_TEACHER, ROLE_ADMIN)
        .antMatchers(HttpMethod.GET, "/subject-enrollments/student/**")
        .hasAnyAuthority(ROLE_STUDENT, ROLE_ADMIN)
        .antMatchers(
            HttpMethod.GET,
            "/subject-enrollments/subject/*",
            "/subject-enrollments/subject/*/student-id/all")
        .hasAnyAuthority(ROLE_TEACHER, ROLE_ADMIN)
        .antMatchers(HttpMethod.PATCH, "/subjects/*/syllabus", "/subject-enrollments/*/grade")
        .hasAnyAuthority(ROLE_TEACHER, ROLE_ADMIN)
        .antMatchers("/subject-materials/**", "/subject-notifications/**", "/subject-terms/**")
        .hasAnyAuthority(ROLE_TEACHER, ROLE_ADMIN)
        .anyRequest()
